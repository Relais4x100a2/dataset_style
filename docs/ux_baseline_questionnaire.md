# Questionnaire perception — baseline UX (issue-020)

Saisie **manuelle** réservée à l’équipe / bêta testeurs internes (pas dans PostgreSQL applicatif v1).

## Objectif

Compléter les métriques « temps + erreurs » par 2 à 3 items **après** un parcours scénario critique (`docs/ux_baseline_issue_020.md`).
...
- Ne pas collecter d’e-mail obligatoire ; pas de texte de corpus dans les réponses libres.
- Agrégation pour revue de bascule : tableur ou export CSV du formulaire interne.
