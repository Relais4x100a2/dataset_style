# Préférences d'affichage (issue-023 / GitHub #145)
...
Les attributs **`data-ds-density`** et **`data-ds-reading`** sur `document.documentElement` servent de **point d'ancrage** pour le futur mapping vers design tokens ou classes utilitaires (issue-022). Aucun token nominatif n'est requis pour livrer issue-023.
